...
import { Mail, Calendar, Edit2, LogOut, Ship, ClipboardCheck, Gauge, Camera, User as UserIcon, Loader2 } from "lucide-react";
...
<Link
                  ...
                  className="group flex items-center gap-2 px-3 py-2 lg:px-2 lg:py-1.5 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors text-xs lg:text-sm"
                  title="Modifier le profil"
                >
                  <Edit2 className="w-4 h-4 flex-shrink-0" />
                  <span className="lg:hidden truncate">Modifier le profil</span>
                </Link>
<button
                  onClick={handleLogout}
                  className="group flex items-center gap-2 px-3 py-2 lg:px-2 lg:py-1.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors text-xs lg:text-sm"
                  title="Déconnexion"
                >
                  <LogOut className="w-4 h-4 flex-shrink-0" />
                  <span className="lg:hidden truncate">Déconnexion</span>
                </button>
              </div>
            </div>
