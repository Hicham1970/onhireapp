        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className={`mb-6 max-w-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
              The next-generation SaaS platform for maritime surveys. 
              Simplify your operations and boost efficiency.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
              © {currentYear} OnHireApp. All rights reserved.
              <span className="mx-2">·</span>
              <span>Created by H. Garroum</span>
            </p>
